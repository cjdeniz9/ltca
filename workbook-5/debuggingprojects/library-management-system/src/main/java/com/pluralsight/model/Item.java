package com.pluralsight.debuggingprojects.LibraryManagementSystem.src.main.java.com.pluralsight.model;
...
public class Item {
    ...
    public boolean equals(Object obj) {
        ...
        Item item = (Item) obj;
        return id.equals(item.id) && title.equals(item.title) && creator.equals(item.creator) && genre.equals(item.genre);
    }
