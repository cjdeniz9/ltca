...
> Fix compile errors before anything else — the project won't build (and tests won't run) until #7, #8, and #9 are resolved.

**Step 1: Compile Errors (fix these first)**
