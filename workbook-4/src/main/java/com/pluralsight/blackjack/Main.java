...
import com.pluralsight.blackjack.enums.PlayerRank;
import com.pluralsight.blackjack.model.Player;
import com.pluralsight.blackjack.service.BlackjackGame;
...
public class Main {
    ...
    private static void displayLeaderboard(Player winner) {
        System.out.println();
        System.out.println("================================");
        System.out.println("            Leaderboard");
        System.out.println("================================");

        System.out.println(PlayerRank.GOLD + ": " + winner.getName());
